...
.
├── app/
│   ├── adk/            # ADK Agent definition ("Curator")
...
* **The Agent as a Curator:** The AI does not replace the researcher; it acts as a "Curator" operating within the strict guardrails provided by the Knowledge Graph (RAG).
...
The **Curator Agent** has access to specialized tools via MCP:
